...
def shopSmart(orderList, fruitShops):
   ...
   orderTotalList=[] # [(shop,orderPrice)]
    ...
    for fShop in fruitShops:
       orderTotalList.append((fShop,fShop.getPriceOfOrder(orderList))) 
    
    #min function returns (fShop,lowestPrice) 
    #then pass only fShop to the return of shopSmart Function.
